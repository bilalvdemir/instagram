...
public class RequestInstagramGetFollow extends AsyncTask<Void, String, String> {

    private AppPreferences appPreferences;
    private String token;
    MainActivity mainActivity;

    public RequestInstagramGetFollow(AppPreferences appPreferences, String token, MainActivity mainActivity) {
    ...
    protected String doInBackground(Void... params) {
        ...
        HttpGet httpGet = new HttpGet(Utils.GET_USER_FOLLOW_URL + token);
        try {
    ...
    protected void onPostExecute(String response) {
        ...
        if (response != null) {
            try {
                ...
                Log.e("response", "----------/follow/----"+jsonObject.toString());
                JSONArray jsonData = jsonObject.getJSONArray("data");
                if (jsonData.length()>660) {
